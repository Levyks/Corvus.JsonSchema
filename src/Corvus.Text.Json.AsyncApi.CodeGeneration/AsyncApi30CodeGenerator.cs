...
// </copyright>
// Modified by Levyks for experimental AsyncAPI consumer support.
...
public sealed class AsyncApi30CodeGenerator
{
    ...
    private GeneratedFile EmitConsumer(OperationInfo op)
    {
        ...
        if (op.SecuritySchemes.Count > 0)
        {
            ...
            {
                EmitParameterizedConsumerChannelConstruction(w, op);
            }
        ...
        if (op.Messages.Count == 1)
        {
            ...
            string channelExpr = hasRuntimeAddress ? "this.subscribedChannel!" : "ChannelAddress";
    ...
    private void EmitParameterizedConsumerChannelConstruction(IndentedWriter w, OperationInfo op)
    {
        w.WriteLine("string channel = ChannelAddressTemplate;");
        ...
        w.WriteLine("this.subscribedChannel = channel;");
        w.WriteLine("this.subscribedChannelUtf8 = Encoding.UTF8.GetBytes(channel);");
        w.WriteLine("this.subscribedDeadLetterChannelUtf8 = Encoding.UTF8.GetBytes(\"dead-letter.\" + channel);");
    }
